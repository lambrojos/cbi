...
var NumberOfTransactionsPerSet = (function (_super) {
    __extends(NumberOfTransactionsPerSet, _super);
    function NumberOfTransactionsPerSet(el) {
        this.rootNodeName = 'NbOfTxsPerSts';
        this.elementDef = numberOfTransactionsPerSetDef;
        _super.call(this, el);
    }
    return NumberOfTransactionsPerSet;
})(cbi_operation_1.ElementWrapper);
exports.NumberOfTransactionsPerSet = NumberOfTransactionsPerSet;
